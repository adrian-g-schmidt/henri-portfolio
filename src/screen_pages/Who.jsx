export default function Who({ handleNavigate }) {
  return (
    <div className="z-20 flex justify-between flex-col p-4 h-full bg-[#2160FF]">
      ...
      <div className="grow w-full h-10 text-left text-xs grid grid-cols-[1fr_2fr_0px] gap-8">
        <div className="flex justify-between flex-col">
          ...
          <div className="flex flex-col justify-between gap-2 text-left">
            <div className="border border-white flex p-[2px] px-[3px] uppercase z-10 w-fit gap-1">
            ...
            <div className="flex flex-col  text-[0.55rem] ">
              <a href="mailto:henri@henriscott.com">henri@henriscott.com</a>
